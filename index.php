...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="site-heading text-center text-white d-none d-lg-block">
      <span class="site-heading-upper text-primary mb-3">Job Search</span>
      <span class="site-heading-lower">  <img src="images/riskyjobs_title.gif" alt="Risky Jobs" /></span>
    </h1>
    <!-- The Search Bar -->
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
      <div class="container">
        <a class="navbar-brand d-lg-none" href="#"><img src="images/riskyjobs_title.gif" alt="Risky Jobs" /></a>
        <div class="navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
        <li class="nav-item active px-lg-4">
            <form method="GET" action="">
                <label for="usersearch" class="searchlabel">Find your risky job:</label>
                ...
                <div class="col-xl-9 mx-auto">
                    <div class="cta-inner text-center rounded">
                        <h2 class="section-heading mb-5">
                            <span class="section-heading-lower">Search Results</span>
                        </h2>
<?php
...
?>
    ...
    <footer class="footer text-faded text-center py-5">
        <div class="container">
            <p class="m-0 small">Risky Jobs 2019</p>
        </div>
    </footer>
